...
const routes: Routes = [
  ...
  {
    path: 'ckeck',
    loadChildren: () => import('./pages/ckeck/ckeck.module').then( m => m.CkeckPageModule)
  },
  {
    path: 'date-time',
  ...
  {
    path: 'loadind',
    loadChildren: () => import('./pages/loadind/loadind.module').then( m => m.LoadindPageModule)
  },
  {
    path: 'modal',
  ...
  {
    path: 'popover',
    loadChildren: () => import('./pages/poppopover/poppopover.module').then( m => m.PoppopoverPageModule)
  },
  {
    path: 'progress',
